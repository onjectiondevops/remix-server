...
import { HeadersFunction, LinksFunction, LoaderFunction, json } from '@remix-run/node';
...
function ErrorDocument({ children, title }: { children: React.ReactNode; title?: string }) {
    return (
